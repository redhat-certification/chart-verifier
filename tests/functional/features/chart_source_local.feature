Feature: Chart local source verification
    ...
    Scenario: The partner IBM succesfully verifies their chart source using the chart verifier docker image
        Given: I am a Red Hat partner from IBM
            ...
            And: I will provide a directory containing error free chart source files.
    ...
    Scenario: RedHat succesfully verifies their chart source using the chart verifier docker image
    ...
    Scenario: Community partner succesfully verifies their chart source using the chart verifier docker image
