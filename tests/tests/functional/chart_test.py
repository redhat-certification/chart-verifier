"""This file contains the tests for chart-verifier. It follows behavioral driven development using pytest-bdd.
...
def check_report(verify_result, profile_type, report_info_location, image_type, verifier_version):
    """Compares the output of chart-verifier against a pre-generated report, containing the expected results.
