...
| [contains-values-schema v1.0](helm-chart-troubleshooting.md#contains-values-schema-v10) | - | - | - | Checks that the Helm chart contains a JSON schema file (`values.schema.json`) to validate the `values.yaml` file in the chart.
| [not-contain-values-schema-remote-ref v1.0](helm-chart-troubleshooting.md#cnot-contain-values-schema-remote-ref-v10) | [not-contain-values-schema-remote-ref v1.0](helm-chart-troubleshooting.md#cnot-contain-values-schema-remote-ref-v10) | [not-contain-values-schema-remote-ref v1.0](helm-chart-troubleshooting.md#not-contain-values-schema-remote-ref-v10) | [not-contain-values-schema-remote-ref v1.0](helm-chart-troubleshooting.md#not-contain-values-schema-remote-ref-v10) | Checks that the Helm chart's JSON schema file (`values.schema.json`) do not contain remote schema references.
...
Each profile also has a version and currently there are four profile versions: v1.0, v1.1, v1.2, and v1.3. The `developer-console` just has two profile version v1.0, and v1.1.
...
|-------|---------|--------|-----------|---------
| [not-contain-values-schema-remote-ref v1.0](helm-chart-troubleshooting.md#not-contain-values-schema-remote-ref-v10) | mandatory | mandatory | mandatory | mandatory
